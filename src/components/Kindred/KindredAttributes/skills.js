...
export const lar = [
  ...
  "••••• You can get into – or out of – the vault of a mul- tinational bank.",
];
export const mel = [
  "Melee",
  ...
  "••••• You are the domain’s weap- onmaster, sought out by Kindred far and wide for your skill.",
];
export const ste = [
  "Stealth",
...
export const ani = [
  ...
  "••• Animals treat you as if you were a warm, friendly owner, unless provoked to do other- wise.",
